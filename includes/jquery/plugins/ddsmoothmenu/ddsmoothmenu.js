...
arrowimages: {down:['downarrowclass', 'includes/jquery/plugins/ddsmoothmenu/down.gif', 23], right:['rightarrowclass', 'http://' + window.location.host + '/ca/includes/jquery/plugins/ddsmoothmenu/right.gif', 6]},
