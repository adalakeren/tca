	...
	_create: function() {
		var self = this,
			...
			if (self.options.resetButton){
				this.element.after('<span class="ui-state-default ui-corner-all '+self.element.attr('id') +' cg-resetButton" title="Reset"><span class="ui-icon ui-icon-circle-close"></span></span>');
			...
			if (self.options.searchButton){
				this.element.after('<span class="ui-state-default ui-corner-all '+ self.element.attr('id') +' cg-searchButton"><span class="ui-icon ui-icon-search" title="Search"></span></span>');
