...
class ca_core extends Controller {
    ...
    function validation(){
      $this->form_validation->set_rules('txtBookingNo', 'txtBookingNo', 'required|xss_clean|min_length[1]|max_length[20]');
    ...
    function newcash() {
        ...
        $throwData['cmbCashDept'] = $helpers->initCmbDepartmentCA("cmbCashDept", "t_department_ca", "t_departmentName", "t_departmentId", "","");
...
//        echo $this->db->last_query();
        ...
        $tableData = '<table>
          ...
          $tableData .= '<tr>     
					...
					<td>'.$rowS->purpose.'</td>
					<td>'.$helper->currencyFormat($rowS->request_amount).'</td>
					<td>'.$helper->currencyFormat($rowS->settled_amount).'</td>
...
//        $throwData['tblDatas'] = $getTable['tblRes'];
    ...
    function initReportOutstanding($getStart, $getEnd, $getCondition) {
        ...
        $helpers = new helpers();
        $tmplTbl = array(
            'table_open' => '<table id="table_detail" width="2500" border="0" cellpadding="0" cellspacing="0">',
            'heading_row_start' => '<tr>',
            'heading_row_end' => '</tr>',
            'heading_cell_start' => '<th>',
            'heading_cell_end' => '</th>',
            ...
            foreach ($getQuery->result() as $rows) {
                ...
                if ($getType == 1){
                  if ($intervalDay > "1" && $intervalDay <= "7") {
                    ...
                    // print_r('warna kuning');
                  } elseif ($intervalDay > "14" && $intervalDay < "366") {
