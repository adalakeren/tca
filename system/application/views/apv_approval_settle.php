...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
           ...
           $('#btn_filter').click(function(){
                ...
                window.document.location.href = "<?php echo base_url(); ?>" + 
                    "index.php/apv_core/settleapproval/" + dep + "/" + req + "/" + type;
            });
        });
        ...
        function openPage(ddl)
        {
            ...
            window.document.location.href = "<?php echo base_url(); ?>index.php/apv_core/settleapproval/" + ddlvalue;
        }
        ...
        function approve(getId){
            var getReason = "";
            $.ajax({
                url: "<?= base_url() ?>index.php/ajax_manager/settleApproval" , 
        ...
        <tr>
            ...
            <td class="secContent2">
                ...
                <div class="dvContent" style="padding-right: 5px">
                    ...
                    <h3 style="margin-top: 20px;margin-bottom: 20px">Table SUJ</h3>
                    <?=$tblDatas?>
